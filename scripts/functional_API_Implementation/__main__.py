...
if __name__ == '__main__':
    ...
    #################################
    seq_length = 500  # 20 100
    Tx = 100
    Tx0 = 0  # this is used to prepare the data, not a part of rnn
    Ty = 400
    Ty0 = 100  # this is used to prepare the data, not a part of rnn
    ...
    # if feature list is empty, consider all the features inside the dataset
    feature_list = ['jLeftKnee_roty_val', 'jRightKnee_roty_val', 'jLeftKnee_roty_vel', 'jRightKnee_roty_vel']
    ...
    if read_data_from_file:
        ...
        n_x = np.size(batch_x_test,2)
        n_y = np.size(batch_y_test,2)
