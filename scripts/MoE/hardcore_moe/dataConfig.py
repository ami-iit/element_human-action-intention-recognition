...
# read data path
#data_path01 = '~/element_human-action-intention-recognition/dataset/lifting_test/StoopLifting.txt'
data_path01 = '~/element_human-action-intention-recognition/dataset/lifting_test/new_data_31dofs.txt'
#data_path02 = '~/element_human-action-intention-recognition/dataset/lifting_test/fileSplit01.txt'
...
# NN setup
output_steps = 25 # prediction horizon (1/0.04=25, 1/0.1=10)
shift = output_steps
...
full_labels = ["standing", "squatting", "rising"]
